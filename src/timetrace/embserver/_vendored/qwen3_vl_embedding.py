# Vendored verbatim from the official Qwen3-VL-Embedding repository
#   https://github.com/QwenLM/Qwen3-VL-Embedding
#   src/models/qwen3_vl_embedding.py  (Apache License 2.0, (c) Alibaba/Qwen team)
#
# Vendored — rather than cloned at runtime — so the embedding server is
# self-contained. Unmodified except this header. The class `Qwen3VLEmbedder`
# below is the public API consumed by ``timetrace.embserver.engine``.
import logging
import os
import unicodedata
...
class Qwen3VLEmbedder:
    ...
    def format_model_input(
        ...
        video: Optional[
            Union[
                List[Union[str, List[Union[str, Image.Image]]]], str, List[Union[str, Image.Image]]
            ]
        ] = None,
